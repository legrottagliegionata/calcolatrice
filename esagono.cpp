...
string Esagono::toString() const{
  ...
  s+= " Lati ab:"+to_string_nozero(lati[0])+ ", bc:"+to_string_nozero(lati[1])+ ", cd:"+to_string_nozero(lati[2])+ ", de:"+to_string_nozero(lati[3])+ ", ef:"+to_string_nozero(lati[4])+ ", fa:"+to_string_nozero(lati[5]);
  return s;
}
